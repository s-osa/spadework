  ...
  describe "#set_status_filter" do
    ...
    [:card, :cod].each do |method|
      describe "when payment method is #{method}" do
        ...
        describe "when nothing written in alert, memo in Rakuten, and comment." do
        ...
        describe "when something written in alert, memo in Rakuten or comment." do
          it "should be 確認待." do
